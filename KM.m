%% Initialization
clear ; close all; clc
%% ============= Part 1: K-Means Clustering on Pixels ===============
%  In this part, first run K-Means on the colors of the pixels in the image and
%  thenmap each pixel on to it's closest centroid.
...
%  In this part, use the clusters of K-Means to
%  compress an image. 
